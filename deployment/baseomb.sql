...
INSERT INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('general', 'coinCode', 'OMB', 'string', 'Coincode to be loaded up w/ the shapeshift getcoins argument.');
