...
cd /usr/local/src
sudo git clone https://github.com/ombre-projects/ombre.git ombre
cd ombre
...
sudo cp ~/nodejs-pool/deployment/ombre.service /lib/systemd/system/
...
sudo systemctl enable ombre.service
sudo systemctl start ombre.service
...
mysql -u root --password=$ROOT_SQL_PASS < deployment/baseomb.sql
